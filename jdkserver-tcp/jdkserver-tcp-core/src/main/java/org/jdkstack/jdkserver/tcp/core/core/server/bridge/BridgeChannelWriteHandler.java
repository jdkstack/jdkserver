 ...
 */
public class BridgeChannelWriteHandler implements Handler<JdkBridgeSocketChannel> {

  /** . */
  private static final Log LOG = LogFactory.getLog(BridgeChannelWriteHandler.class);
