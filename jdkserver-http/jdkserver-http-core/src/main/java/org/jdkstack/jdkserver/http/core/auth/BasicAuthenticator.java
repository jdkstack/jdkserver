...
import org.jdkstack.jdkserver.http.core.HttpExchange;
import org.jdkstack.jdkserver.http.core.standard.Headers;

/**
 * BasicAuthenticator provides an implementation of HTTP Basic authentication. It is an abstract
 * class and must be extended to provide an implementation of {@link
 * #checkCredentials(String,String)} which is called to verify each incoming request.
 */
public abstract class BasicAuthenticator extends Authenticator {
  ...
  public Result authenticate(HttpExchange t) {
    ...
    if (checkCredentials(uname, pass)) {
      return new Success(new HttpPrincipal(uname, realm));
    } else {
