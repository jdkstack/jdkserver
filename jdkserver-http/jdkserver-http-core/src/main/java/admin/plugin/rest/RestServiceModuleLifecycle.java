...
import admin.http.annotation.DeleteMapping;
import admin.http.annotation.GetMapping;
import admin.http.annotation.PatchMapping;
import admin.http.annotation.PostMapping;
import admin.http.annotation.PutMapping;
...
import admin.plugin.Plugin;
import admin.plugin.PluginEntity;
import admin.plugin.PluginServiceLifecycle;
import admin.plugin.PluginServices;
