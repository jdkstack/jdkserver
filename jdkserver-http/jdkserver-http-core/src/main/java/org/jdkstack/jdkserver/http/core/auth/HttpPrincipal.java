...
public class HttpPrincipal implements Principal {
  ...
  /**
   * Compares two HttpPrincipal. Returns <code>true</code> if <i>another</i> is an instance of
   * HttpPrincipal, and its username and realm are equal to this object's username and realm.
  ...
  /**
   * returns a hashcode for this HttpPrincipal. This is calculated as <code>
   * (getUsername()+getRealm().hashCode()</code>
   */
  public int hashCode() {
