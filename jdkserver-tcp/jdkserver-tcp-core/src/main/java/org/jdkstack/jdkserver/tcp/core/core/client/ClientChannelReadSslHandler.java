 ...
 */
public class ClientChannelReadSslHandler implements Handler<JdkClientSocketChannel> {

  /** . */
  private static final Log LOG = LogFactory.getLog(ClientChannelReadSslHandler.class);
