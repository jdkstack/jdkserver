...
import org.jdkstack.jdkserver.http.core.auth.AuthFilter;
 ...
 * to a {@link HttpHandler} which is invoked to handle requests destined for the protocol/path on
 * the associated HttpServer.
 *
 * <p>HttpContext instances are created by {@link HttpServer#createContext(String,String,
 * HttpHandler,Object)}
 *
 * <p>
 */
