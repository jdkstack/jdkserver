...
public interface HttpHandler {
  /**
   * Handle the given request and generate an appropriate response. See {@link HttpExchange} for a
   ...
   */
  public abstract void handle(Exchange exchange) throws IOException;
}
