...
public class JdkBridgeSocketChannel extends AbstractJdkChannel implements JdkBridgeChannel {
  ...
  private final Handler<JdkBridgeSocketChannel> handler = new BridgeChannelReadWriteHandler();
  private final BridgeChannelHandler bridgeChannelHandler = new BridgeChannelHandler(handler);
  ...
  public JdkBridgeSocketChannel(ServerSocketChannel serverSocketChannel, Selector selector) {
    try {
      ...
      this.ctx = new DefaultChannelHandlerContext(socketChannel, bridgeChannelHandler);
