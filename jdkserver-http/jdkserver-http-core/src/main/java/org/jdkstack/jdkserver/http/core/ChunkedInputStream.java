...
class ChunkedInputStream extends LeftOverInputStream {
  ...
  /**
   * returns the number of bytes available to read in the current chunk which may be less than the
   * real amount, but we'll live with that limitation for the moment. It only affects potential
