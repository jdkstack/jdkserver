 ...
 */
public class ClientChannelWriteSslHandler implements Handler<JdkClientSocketChannel> {

  /** . */
  private static final Log LOG = LogFactory.getLog(ClientChannelWriteSslHandler.class);
